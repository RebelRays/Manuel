...
def load_model8():
    ...
    model2 = tf.keras.models.Sequential([
    tf.keras.layers.Conv2D(52, (3, 3), activation='relu', input_shape=(60,60, 3)),
    tf.keras.layers.MaxPooling2D((2, 2)),
    ...
    modelfile= "tensormodel/cp_60-60_52-42-32-005_0070_0.992686.ckpt"
    model2.load_weights(modelfile)
    model = model2
    modelInputDim = (60,60)
...
def load_model7():
    ...
    modelfile= "tensormodel/cp_60-60_52-42-32-004_0136_0.997089.ckpt"
    model2.load_weights(modelfile)
    model = model2
    modelInputDim = (60,60)
...
def load_model6():
    ...
    #model2 =tf.keras.models.load_model("tensormodel/best")
    model2 = tf.keras.models.Sequential([
    tf.keras.layers.Conv2D(46, (3, 3), activation='relu', input_shape=(60,60, 3)),
    tf.keras.layers.MaxPooling2D((2, 2)),
    tf.keras.layers.Dropout(0.04),
    ...
    modelfile= "tensormodel/cp_60-60_46-d-28-001_0098_0.9941.ckpt"
    model2.load_weights(modelfile)
    model = model2
    modelInputDim = (60,60)
...
def load_model5():
    ...
    modelfile= "tensormodel/cp_60-60_44-d-26-005_0092.ckpt"
    model2.load_weights(modelfile)
    model = model2
    modelInputDim = (60,60)
